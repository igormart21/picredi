   ...
   return (
     <footer className="bg-card border-t border-border">
       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         ...
         <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
           ...
           >
             <Link href="/" className="flex items-center space-x-2 mb-6">
               <img src="/assets/LOGO%2004%20quadrado.png" alt="Picredi Logo" className="h-8 w-auto" />
             </Link>
 
             <p className="text-muted-foreground mb-6 max-w-sm">
               O banco digital que combina tecnologia de ponta com o atendimento personalizado que você merece. Sua vida
           ...
           <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }}>
            ...
            <div className="mt-6 space-y-3">
              <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Baixe o app Picredi</h4>
              <div className="flex items-center gap-3">
                <Link href="/ajuda" className="inline-flex">
                  <img
                    src="/assets/apple.png"
                    alt="Disponível na App Store"
                    className="h-11 w-auto transition-transform hover:scale-105 object-contain"
                  />
                </Link>
                <Link href="/ajuda" className="inline-flex">
                  <img
                    src="/assets/disponivel-google-play-badge-1.png"
                    alt="Disponível no Google Play"
                    className="h-[2.375rem] w-auto transition-transform hover:scale-105 object-contain"
                  />
                </Link>
              </div>
            </div>
         ...
         >
           <div className="text-sm text-muted-foreground">© 2024 Picredi. Todos os direitos reservados.</div>
